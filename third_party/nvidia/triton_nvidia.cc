...
static std::unique_ptr<mlir::Pass> createTritonGPUFenceInsertionWrapper(int32_t capability) {
...
static std::unique_ptr<mlir::Pass> createTritonGPUProxyFenceInsertionWrapper(int32_t capability) {
