...
void init_triton_ir(py::module &&m) {
  ...
  py::class_<TritonOpBuilder>(m, "builder", py::module_local(),
      ...
      .def("create_descriptor_load",
           [](TritonOpBuilder &self, Value &desc_ptr, std::vector<Value>& indices, Type type,
              CacheModifier cacheModifier, EvictionPolicy evictionPolicy) -> Value {
             return self.create<ExperimentalDescriptorLoadOp>(type, desc_ptr, indices, cacheModifier, evictionPolicy);
           })
      .def("create_reshape",
