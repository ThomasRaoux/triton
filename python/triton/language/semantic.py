...
def descriptor_load(desc_ptr: tl.tensor, offsets, cache_modifier: str, eviction_policy: str, type, builder: ir.builder) -> tl.tensor:
    offsets = _convert_to_ir_values(builder, offsets, require_i64=False)
    x = builder.create_descriptor_load(desc_ptr.handle, offsets, type.to_ir(builder), _str_to_load_cache_modifier(cache_modifier),
