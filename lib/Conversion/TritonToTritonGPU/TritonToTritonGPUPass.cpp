...
struct ExtractTensorSliceOpPattern : public OpConversionPattern<triton::ExtractTensorSliceOp> {
  using OpConversionPattern<triton::ExtractTensorSliceOp>::OpConversionPattern;

  LogicalResult
  matchAndRewrite(triton::ExtractTensorSliceOp op, triton::ExtractTensorSliceOp::Adaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
