...
//===----------------------------------------------------------------------===//
//
// This pass works after shared memory allocation, inserting fences to ensure that
...
public:
  ...
  void runOnOperation() override {
    ...
    ModuleMembarOrFenceAnalysis<ProxyFenceAnalysis> analysis(&allocation, filterFn);
    analysis.run();
  }
};
