...
makeOptimizingPipeline(unsigned optLevel, unsigned sizeLevel,
  ...
  return [optLevel, sizeLevel, targetMachine](Module *m) -> Error {
    ...
    // Disable SLP vectorization as it doesn't generate ideal code for NVPTX,
    // instead we run our own straight-line code vectorizer.
    ...
    // Run pre-processing pass. TODO: this could be add with the rest of the
    // optimizations.
